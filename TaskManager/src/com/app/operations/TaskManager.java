...
public interface TaskManager {
	...
	void addTask(String taskName, String description, String taskDate, String status);

	String deleteTask(int taskId);

	String updateTaskStatus(int taskId, String status);

	void displayAllPendingTasks();

	void displayAllTaskForToday();
